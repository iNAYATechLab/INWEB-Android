...
/*
 * INWEB runtime module · tunnel
 *
 * ভারী optional বাইনারি (`libexec_cloudflared.so`) এই ছোট APK-তে বসে; মূল অ্যাপ সেটার
 ...
 *        ./gradlew :runtime-modules:tunnel:assembleRelease (MODULE_VERSION* env)
 */
...
android {
    namespace = "com.inweb.app.runtime.tunnel"

    // module-র নিজস্ব SDK সেটিং দরকার — :app থেকে inherit হয় না
    compileSdk = 35

    defaultConfig {
        applicationId = "com.inweb.app.runtime.tunnel"
        minSdk = 26
        targetSdk = 35
        versionCode = modCode
